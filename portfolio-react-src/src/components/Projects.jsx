...
const projects = [
  {
    ...
    github: 'hhttps://github.com/kalviumcommunity/S75_Abishek_Captone_project_Heart-connect',
  ...
  },
  {
    ...
    github: 'https://github.com/Abishek1528/HouseZone',
    demo: null,
    featured: false,
    image: '/project2.png',
  },
{
  id: '03',
  name: 'Aahar AI',
  subtitle: 'Intelligent Diet & Nutrition Planning System',
  desc: 'A Python-based health application that calculates BMI, BMR, and TDEE using standard medical formulas. It provides personalized daily calorie recommendations based on user activity level and fitness goals through an interactive Streamlit web interface.',
  impact: '🥗 Helps users make data-driven diet decisions by providing personalized nutrition insights and calorie planning.',
  tech: ['Python', 'Streamlit', 'HTML', 'CSS', 'JSON', 'MongoDB'],
  icon: '🥗',
  accentColor: 'rgba(255, 165, 0, 0.4)',
  github: 'https://github.com/Abishek1528/Aahar_AI', 
  demo: null, 
  featured: true,
  image: '/project3.png',
}
